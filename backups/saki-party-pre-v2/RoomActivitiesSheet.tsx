...
export default function RoomActivitiesSheet({ roomId, onClose }: RoomActivitiesSheetProps) {
...
// ── Game Panel ────────────────────────────────────────────────────────────────
function GamePanel({ gameId, roomId, onClose }: { gameId: string; roomId: string; onClose: () => void }) {
  return (
    <>
