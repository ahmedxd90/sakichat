...
export default function YoutubeSettingsSubPage({ roomId, onBack }: Props) {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (ytId) {
        ...
        toast.success("تم تشغيل الفيديو فيلم");
        setSearchQuery("");
        setLoading(false);
        setSearching(false);
        return;
  ...
  return (
    <div className="flex flex-col h-screen" style={{ background: "linear-gradient(180deg,#080000 0%,#120000 50%,#0d0000 100%)" }} dir="rtl">
      {/* Header */}
      <div className="flex items-center gap-3 px-4 py-4 flex-shrink-0" style={{ borderBottom: "1px solid rgba(59,130,246,0.2)" }}>
        ...
        <div className="flex-1 flex items-center gap-2">
          <span className="text-xl">فيلم</span>
          <div>
            <h2 className="text-white font-bold text-base leading-tight">شاشة السينما</h2>
            <p className="text-blue-400/70 text-[10px]">ابحث وشغّل لجميع الأعضاء</p>
          </div>
        </div>
        {currentVideoId && (
          <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full" style={{ background: "rgba(59,130,246,0.2)", border: "1px solid rgba(59,130,246,0.4)" }}>
            <div className="w-1.5 h-1.5 bg-blue-400 rounded-full animate-pulse" />
            <span className="text-blue-300 text-[10px] font-bold">LIVE</span>
          </div>
        )}
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
        ...
        {/* Current video */}
        {currentVideoId && (
          <div className="rounded-2xl overflow-hidden" style={{ border: "1px solid rgba(59,130,246,0.3)", background: "rgba(59,130,246,0.06)" }}>
              ...
              {currentIsYt ? (
                <div className="relative flex-shrink-0">
                  ...
                  <div className="absolute inset-0 rounded-xl flex items-center justify-center" style={{ background: "rgba(0,0,0,0.3)" }}>
                    <div className="w-6 h-6 rounded-full flex items-center justify-center" style={{ background: "rgba(59,130,246,0.9)" }}>
                      <svg width="8" height="8" viewBox="0 0 24 24" fill="white"><polygon points="6,3 20,12 6,21" /></svg>
                    </div>
                  </div>
                </div>
              ) : (
                <div className="w-20 h-14 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: "rgba(59,130,246,0.15)" }}>
                  <span className="text-2xl">فيلم</span>
                </div>
              )}
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <input
              ...
              style={{ background: "rgba(255,255,255,0.07)", border: "1px solid rgba(59,130,246,0.3)" }}
              dir="rtl"
            />
            <button
        ...
        {selectedVideo && (
          <div className="rounded-2xl p-3" style={{ background: "rgba(59,130,246,0.12)", border: "2px solid rgba(59,130,246,0.5)" }}>
            <p className="text-blue-300 text-[10px] font-bold mb-2">✅ تم اختيار الفيديو — اضغط تشغيل</p>
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-blue-300/70 text-[10px] mt-1">{selectedVideo.channelTitle}</p>
              </div>
              ...
              >
                <div className="relative flex-shrink-0">
                  ...
                  <div className="absolute inset-0 rounded-xl flex items-center justify-center" style={{ background: "rgba(0,0,0,0.35)" }}>
                    <div className="w-8 h-8 rounded-full flex items-center justify-center" style={{ background: "rgba(59,130,246,0.9)" }}>
        ...
        {searchResults.length === 0 && !searching && !selectedVideo && (
          <div className="flex flex-col items-center justify-center py-10 gap-4">
            <div className="w-20 h-20 rounded-3xl flex items-center justify-center" style={{ background: "rgba(59,130,246,0.1)", border: "1px solid rgba(59,130,246,0.2)" }}>
              <span className="text-4xl">فيلم</span>
            </div>
        ...
        {/* Info */}
        <div className="rounded-2xl px-4 py-3" style={{ background: "rgba(59,130,246,0.05)", border: "1px solid rgba(59,130,246,0.15)" }}>
