...
- [ ] فحص سياسات INSERT في `rooms` وقيمة `owner_id` الفعلية.
- [ ] إضافة سياسة آمنة تسمح للمستخدم المصادق بإنشاء غرفته فقط.
- [ ] التحقق من حقول الغرفة وسياسات التخزين ثم تشغيل TypeScript وVite build.
- [ ] إعادة بناء APK/AAB واختبار إنشاء غرفة فعلياً.
