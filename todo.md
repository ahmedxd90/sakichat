...
- [ ] فحص الرابط المرجعي واستخراج التصميم (الألوان، الرتب، المزايا).
- [ ] مراجعة `AristocracyPage.tsx` الحالية ومخطط `aristocracy_levels`.
- [ ] تنفيذ الواجهة الجديدة باستخدام Tailwind مع التفاعلات والرسوم المتحركة.
- [ ] ربط البيانات الحقيقية (الرتبة الحالية، شريط التقدم، المكافآت) بـSupabase.
- [ ] التحقق من استقرار الصفحة في نسخة الويب وبناء Android v1.1.4 المحدّث.
